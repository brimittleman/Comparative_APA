...
#nuclear apa  
NucAPA=read.table("../data/DiffIso_Nuclear/SignifianceEitherPAS_2_Nuclear.txt",header = T,stringsAsFactors = F)
#totalAPA  
totAPA=read.table("../data/DiffIso_Total/SignifianceEitherPAS_2_Total.txt",header = T,stringsAsFactors = F)
