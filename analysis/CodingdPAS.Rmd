...
```{r}
Meta=read.table("../data/PAS_doubleFilter/PAS_10perc_either_HumanCoord_BothUsage_meta_doubleFilter.txt", header = T,stringsAsFactors = F) %>% select(PAS, chr, start, end, loc,disc,Human,Chimp)  %>% rename('Usage_human'=Human, 'Usage_chimp'=Chimp)
...
333 of these. 207 up in chimp, 126 up in human  
