...
Take the 5 perc PAS from the annotatePAS analysis and filter those with scores > .05 i human.
```{r}
compAPAPAS=read.table("../data/Peaks_5perc/Peaks_5perc_either_HumanCoordHummanUsage.bed", header =   T, stringsAsFactors = F)  %>%  filter(Human>=0.05)
```
...
```
This is a bit strange. I would expect more overlap. Maybe these are low expressed genes. 
