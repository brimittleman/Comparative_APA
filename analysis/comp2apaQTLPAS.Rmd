...
Still a not high overlap, but it is goood to see those that overlap are the higher used.  
...
It look like some of them are off by just a few basepairs. To be more liberal with this analysis, I will increase the size of the apaQTLs by 50 on each side. 
