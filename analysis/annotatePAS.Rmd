...
**Problem: called twice when the PAS is called in both species. but is off. I need a way to deal with pas called in either fractio but are only 1 or 2 basepairs off. **
