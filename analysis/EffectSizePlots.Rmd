...
```{r}
deloc=ggplot(DeandAPA,aes(y=deltaPAU, x=logFC,col=loc)) + geom_point(alpha=.3) + geom_smooth(aes(col=loc), method="lm") + labs(title="Intronic and 3' UTR APA v DE") + scale_color_brewer(palette = "Dark2",labels=c("Intronic", "3' UTR"), name="")+ stat_cor(aes(color = loc), label.x = -6)

```

```{r}
de=ggplot(DeandAPA,aes(y=deltaPAU, x=logFC)) + geom_point(alpha=.3) + geom_smooth(method="lm") + labs(title="Intronic and 3' UTR APA v DE") + scale_color_brewer(palette = "Dark2")+ stat_cor( label.x = -7)
```


```{r}
facet=ggplot(DeandAPA_Dom,aes(y=deltaPAU, x=logFC,col=loc)) + geom_point(alpha=.3) + geom_smooth(aes(col=loc), method="lm") + labs(title="Intronic and 3' UTR APA v DE\ gene with dominance") + scale_color_brewer(palette = "Dark2",labels=c("Intronic", "3' UTR"), name="")+ stat_cor(aes(color = loc), label.x = -5) + facet_grid(~Set)
```
...
```{r}
same=ggplot(DeandAPA_Dom_same,aes(y=deltaPAU, x=logFC,col=loc)) + geom_point(alpha=.3) + geom_smooth(aes(col=loc), method="lm") + labs(title="Intronic and 3' UTR APA v DE: Same Dominant") + scale_color_brewer(palette = "Dark2",labels=c("Intronic", "3' UTR"), name="")+ stat_cor(aes(color = loc), label.x = -7)
```

```{r}
diff=ggplot(DeandAPA_Dom_Diff,aes(y=deltaPAU, x=logFC,col=loc)) + geom_point(alpha=.3) + geom_smooth(aes(col=loc), method="lm") + labs(title="Intronic and 3' UTR APA v DE: Different Dominant") + scale_color_brewer(palette = "Dark2",labels=c("Intronic", "3' UTR"), name="")+ stat_cor(aes(color = loc), label.x = -7)
```
