...
```{r,eval=F}
ggdotchart(ResDF,y="Enrich",x= "set", color="set",add = "segments", rotate = TRUE, dot.size = 10,  label = round(ResDF$Enrich,2), font.label = list(color = "black", size = 10, vjust = 0.5),ggtheme = theme_pubr(), legend="none", palette="RdYlBu", title="Enrichment for DE and dAPA Different Dominant") + geom_hline(yintercept = 1)

ggdotchart(ResDFSame,y="EnrichSame",x= "set", color="set",add = "segments", rotate = TRUE, dot.size = 10,  label = round(ResDFSame$EnrichSame,2), font.label = list(color = "black", size = 10, vjust = 0.5),ggtheme = theme_pubr(), legend="none", palette="RdYlBu", title="Enrichment for DE and dAPA Same Dominant") + geom_hline(yintercept = 1)
```
