...
diffE=ggplot(ResDF,aes(x=set, y=Enrich,fill=set)) + geom_bar(stat="identity") + geom_hline(yintercept = 1)+labs(title="Enrichment for DE and different dominant")+ scale_fill_brewer(palette = "RdYlBu") + theme(legend.position = "none")
```
...
SameE=ggplot(ResDFSame,aes(x=set, y=EnrichSame,fill=set)) + geom_bar(stat="identity") + geom_hline(yintercept = 1)+labs(title="Enrichment for DE and same dominant")+ scale_fill_brewer(palette = "RdYlBu") + theme(legend.position = "none")
```
```{r}
