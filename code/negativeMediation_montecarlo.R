load("../data/mediation/negative_mediation.rda")
library(MASS)
...
saveRDS(mc_de, file = "../data/mediation/mc_de_negative.rds")
...
saveRDS(mc_node, file = "../data/mediation/mc_node_negative.rds")
