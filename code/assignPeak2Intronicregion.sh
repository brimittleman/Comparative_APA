...
bedtools intersect -a ../data/SpliceSite/transcriptMinusexon_hg38.bed -b ../data/SpliceSite/IntronicPAS_humanCoord.bed -s -wa -wb > ../data/SpliceSite/IntronincPAS2Introns_humanCoord.bed
